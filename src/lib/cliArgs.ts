...
export function printCliHelp(): void {
  process.stdout.write(
    [
      ...
      "Usage:",
      "  polterbase",
      "  polterbase app setup ops [--path <dir>] [--create-project|--use-existing-project] [--yes]",
      "  polterbase app link ops [--path <dir>] [--relink]",
      "  polterbase app migrate ops [push|lint|reset|local-reset] [--path <dir>] [--relink]",
      "  polterbase app configure ops [--path <dir>] [--yes]",
      "  polterbase app install ops [--version <version>] [--artifact-url <url>] [--install-dir <dir>] [--yes]",
      "  polterbase app update ops [--version <version>] [--artifact-url <url>] [--install-dir <dir>] [--yes]",
      "",
      "Notes:",
      ...
      "  - Use --artifact-url or POLTERBASE_OPS_MACOS_ARTIFACT_URL to override the downloaded asset.",
      "  - Use POLTERBASE_OPS_GITHUB_REPO=owner/repo to resolve releases from a different repository.",
      "",
    ].join("\n"),
  );
}
